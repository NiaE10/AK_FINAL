from PySide6.QtWidgets import QWidget, QVBoxLayout, QLabel, QTableWidget, QHeaderView, QTableWidgetItem, QPushButton, QHBoxLayout
...
class InicioVista(QWidget):
    ...
    def _create_table(self):
        ...
        table.setColumnWidth(COL_ACCIONES, 180)
        return table
    ...
    def mostrar_alertas(self, alertas):
        ...
        for row_idx, data_row in enumerate(alertas):
            ...
            self.table.setItem(row_idx, COL_CLASES_REST, QTableWidgetItem(str(clases_restantes)))
    ...
    def _add_action_buttons(self, row_idx, id_alumno, id_inscripcion):
        ...
        # Solución a la alineación vertical
        acciones_layout.setAlignment(Qt.AlignTop | Qt.AlignCenter)
